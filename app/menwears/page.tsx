...
import { menDatas, Data } from '../data'
...
const Menwears = () => {
  ...
  const [searchResults, setSearchResults] = useState<Data[]>(menDatas);
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="px-10 pt-5">
        <Banner searchTerm={searchTerm} setSearchTerm={setSearchTerm} setSearchResults={setSearchResults} searchResults={searchResults} image='url(image/men.jpg)' />
        <div className="my-8">
          <div className="text-lg font-semibold">listed Men Wears</div>
